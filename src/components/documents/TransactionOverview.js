          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <div style={{
              ...
              <span style={{ fontWeight: '500' }}>
                {transaction.timeline?.proposalAccepted?.toDate().toLocaleDateString()}
              </span>
            </div>
            ...
            {transaction.timeline?.inspectionDeadline && (
              <div style={{
                ...
                <span style={{ fontWeight: '500' }}>
                  {new Date(transaction.timeline.inspectionDeadline).toLocaleDateString()}
                </span>
              </div>
            )}
            ...
            {transaction.timeline?.expectedClosing && (
              <div style={{
                ...
                <span style={{ fontWeight: '600', color: '#92400e' }}>
                  {new Date(transaction.timeline.expectedClosing).toLocaleDateString()}
                </span>
              </div>
            )}
          </div>
